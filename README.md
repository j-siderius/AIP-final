...
#### [Original repository](https://github.com/j-siderius/AIP-final)
<br>
...
The player is stranded on an island with lush fields, dense forests and big mountains.
...
### Gameplay
1. To move your hero around the island, you either use your mouse or the joystick to select adjacent tiles,
...
3. During the night, creepy undead beings will spawn from the ground and try to devour you! Avoid their bites by
...
<div align="center">
    <img src="Doc/Inheritance_diagram.png" alt="Class reference diagram" width="65%">
...
<div align="center">
    <img src="Doc/AI1.png" alt="Pathfinding normal terrain" width="65%">
    <img src="Doc/AI2.png" alt="Pathfinding around walls" width="45%">
    <img src="Doc/AI3.png" alt="Pathfinding through walls" width="45%">
</div>
...
- Hexagonal tiles: [Fantasy Hex tiles by CuddlyClover](https://cuddlyclover.itch.io/fantasy-hex-tiles)
- Player and Enemy sprites: [Dungeon tileset II by 0x72](https://0x72.itch.io/dungeontileset-ii)
- Wood sprite: [16x16 RPG items by Joey de Jong](https://www.artstation.com/artwork/gJNd3Z)
- Color palette: [Linear 8-bit palette by GrafxKid](https://lospec.com/palette-list/linear-color-palette-basic)
- Athelas font: [Adobe fonts](https://fonts.adobe.com/fonts/athelas)